...
def process_video_to_vertical(input_video, final_output_video, aspect_ratio=ASPECT_RATIO):
    ...
    # Per-stage wall time for local diagnostics.
...
def _run_gemini_stage(client, model_name, prompt, schema):
    ...
    for attempt in range(1, max_attempts + 1):
        try:
            ...
            # Policy blocks are deterministic — retrying wastes model calls;
            # the user deserves the real reason instead of a generic
